...
/**
 * LoginForm — pure presentational. Receives onSubmit + state via props.
 */
  ...
  return (
    <div>
      ...
      <p className="mt-8 text-center text-sm text-slate-500">
        ...
        <Link to={ROUTES.REGISTER} className="font-semibold text-primary-600 hover:text-primary-700 transition-colors">
          Sign up
        </Link>
      </p>
    </div>
